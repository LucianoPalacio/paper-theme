...
Check out the [Jekyll Paper docs][jekyll-paper-docs]{:target="_blank"} or [Jekyll docs][jekyll-docs]{:target="_blank"} for more info on how to get the most out of Jekyll. If you have questions or suggestions, you can create an issue to asking them on [Jekyll Paper Issues][jekyll-paper-issues]{:target="_blank"} or [Jekyll Talk][jekyll-talk]{:target="_blank"}.
